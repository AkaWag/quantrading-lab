...
|---|---|---|---|---|---|---|---|---|---|---|---|
| QT-R-001 | NEW_STRATEGY | XAUUSD Global Session Transition and London Breakout Research | Aka Wag | HYPOTHESIS | BREAKOUT (SESSION, VOL, MOMENTUM) | XAUUSD | 15m | ../strategies/20260721-xauusd-global-session-transition-london-breakout/HYPOTHESIS.md | none | 2026-07-21 | Controlled research specification review (accept/revise options draft; choose Asia anchor/windows); then pre-register experiment plan — no Pine / QT-S-### |
