...
- **Discord / mailbox idea intake / Dizzy** → `dizzy` (see [`DIZZY_AGENT.md`](DIZZY_AGENT.md),
  ADR-009, [`tools/dizzy/`](../../tools/dizzy/README.md)).
...
- Central orchestration of research tasks → `research-director` (consumes Shotgun and Dizzy packets).
...
- [`DIZZY_AGENT.md`](DIZZY_AGENT.md) — Dizzy Discord/mailbox intake agent
- [`.cursor/skills/dizzy/SKILL.md`](../../.cursor/skills/dizzy/SKILL.md) — Dizzy Cursor skill
