---
name: pine-compiler-triage
description: Resolve compiler evidence
---
# Resolve compiler evidence

## Mandate
Use exact TradingView compiler messages and line context to propose minimal fixes. Never state that code compiles unless the user supplies successful compiler evidence.
